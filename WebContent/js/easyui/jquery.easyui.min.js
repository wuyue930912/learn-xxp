...
bb.num.bind('keypress',function(e){
	 var presstxtA;
	    var presstxt;
...
_4cf.removeAttr("readonly").removeClass("textbox-readonly");
if(opts.readonly||!opts.editable){
_4cf.attr("readonly","readonly").addClass("textbox-readonly");
}
};
...
//start加入新精度-1，此时不进行转换，min和max属性可能失效zhouchenxuan
if(opts.precision == -1){
	if(isNaN(s)){
		s="";
	}
